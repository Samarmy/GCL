...
_, dataset, _, _ = torch.utils.data.random_split(dataset, [0.25, 0.25, 0.25, 0.25], generator=generator1)
...
for ind, data in enumerate(loader):  
    if (((ind/len(loader))*100.0) < 23.28369510348309):
        print("skipping")
        continue
    with torch.no_grad():
...
#     break
    ...
    torch.save(((ind/len(loader))*100.0), "Encoder_Inversion1_Checkpoint.pt")