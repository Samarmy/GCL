...
_, _, dataset, _ = torch.utils.data.random_split(dataset, [0.25, 0.25, 0.25, 0.25], generator=generator1)
...
for ind, data in enumerate(loader):
    if (((ind/len(loader))*100.0) < 34.80565371024735):
        print("skipping")
        continue
    with torch.no_grad():
...
#     break
    ...
    torch.save(((ind/len(loader))*100.0), "Encoder_Inversion2_Checkpoint.pt")